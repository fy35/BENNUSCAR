...
const Footer = () => {
  return (
    <div className="bg-white sm:p-6 dark:bg-gray-800 border-t-[1px]">
      <footer className="max-w-screen-2xl mx-auto p-4 bg-white sm:p-6 dark:bg-gray-800">
          ...
          <div className="mb-6 md:mb-0">
            <Link to="/" className="flex items-center relative">
              ...
              <div className=" bg-emerald-700 dark:bg-white rounded-tr-full rounded-br-full absolute left-8 z-0">
                <span className=" ml-2 self-center text-xl font-semibold whitespace-nowrap text-white dark:text-emerald-700 pr-2 ">BENNUSCAR.</span>
              </div>
            </Link>
          </div>
