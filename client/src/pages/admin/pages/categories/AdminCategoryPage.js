...
const AdminCategoryPage = ({ history }) => {
  /***************************
   ****** COMP STATES *****
   ***************************/
    ...
    const fetchCategories = async () => {
      ...
      try {
        const res = await axios.get(
          `/api/private/category/getcategories?sort=desc&skip=${page}&limit=${limit}}`,
          config
        );
          ...
          <>
            {categories ? (
              <>
                ...
                <Table autoHeight data={categories} id="table">
                  <Column width={80} align="center">
                    <HeaderCell>Image</HeaderCell>
                    <ImageCell dataKey="categoryImage" />
                  </Column>
                  <Column width={160}>
